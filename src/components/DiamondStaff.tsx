...
export default function DiamondStaff() {
  ...
  return (
    <div className="relative w-full h-[100vh] flex flex-col justify-center items-center overflow-hidden bg-black text-white selection:bg-emerald-900 selection:text-white">
      ...
      >
          ...
          <div className="z-[100] flex flex-col items-center justify-center absolute top-[30%] -translate-y-[50%] mt-8">
             <h1 className="text-black font-morris tracking-widest uppercase text-6xl sm:text-7xl md:text-8xl lg:text-9xl text-center leading-none" style={{ textShadow: "0 0 20px rgba(255,255,255,0.5), 0 0 40px rgba(16,185,129,0.3)" }}>
                STUDIFY
             </h1>
          </div>
      </motion.div>
      ...
      >
         <h2 className="text-white text-lg sm:text-2xl font-serif italic tracking-wide font-light text-center drop-shadow-[0_0_15px_rgba(16,185,129,0.6)]">
         ...
         >
            <div className="px-12 py-5 border border-white/20 bg-black/40 hover:bg-emerald-950/40 rounded-full backdrop-blur-xl shadow-[0_0_30px_rgba(255,255,255,0.1)] hover:shadow-[0_0_50px_rgba(16,185,129,0.6)] hover:border-emerald-500/50 transition-all border-b-white/50">
               <span className="text-white font-serif font-black tracking-[0.25em] uppercase text-2xl flex items-center gap-3">
                 PLAY <ArrowDown className="w-5 h-5 group-hover:translate-y-2 group-hover:text-emerald-300 transition-all duration-300" />
               </span>
            </div>
         </button>

         <p className="text-white/50 font-serif text-sm tracking-widest mt-1 uppercase drop-shadow-md">
